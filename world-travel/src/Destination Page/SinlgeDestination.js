...
import { getSingleDestination } from './redux/action';
...
const SinlgeDestination = () => {
  ...
  const { isLoading, isError, data } = useSelector((store) => ({
    ...
    data: store?.destinationReducer?.destination
  }));
        ...
        <div className="row" >
          ...
          <div className='col-md-8 d-flex gap-3' >
            <div className='col-md-5'>
              <img width={"100%"} src={data.images[1]} alt="imageone" />
            </div>
            <div className='col-md-5 d-flex flex-column justify-content-between'>
              <div className='col-md-12'>
                <img width={"100%"} src={data.images[0]} alt="imageone" />
              </div>
              <div className='col-md-12'>
                <img width={"100%"} src={data?.image} alt="imagetwo" />
              </div>
            </div>
          </div>
        </div>
