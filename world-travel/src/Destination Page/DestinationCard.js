...
const DestinationCard = ({ id, image, city, country, rating, locality }) => {
    return (
        <DIV className="">
            ...
            <h4 className='country' ><svg width="33" height="33" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className='my-3' >
                <Link style={{ textDecoration: "none", color: "white", fontWeight: 'bold' }} to={`/destination/${id}`} >View Nearby Hotels</Link>
            </button>
        </DIV>
    )
}
